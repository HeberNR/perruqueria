...
public class DatosPrecargados {
  public static Mascota[] obtenerMascotas() {
    return new Mascota[]{
  ...
  public static Turno[] obtenerTurnos() {
    Mascota[] mascotas = obtenerMascotas();
    return new Turno[]{
        new Turno("2023-10-01", "10:00", EstadoServicio.PROGRAMADO,
            mascotas[0], new Servicio(TipoServicio.BAÑO, "Baño completo", 90, 500)),
        new Turno("2023-10-02", "11:00", EstadoServicio.PROGRAMADO,
            mascotas[1], new Servicio(TipoServicio.PELUQUERIA, "Corte de pelo", 45, 800)),
        new Turno("2023-10-03", "12:00", EstadoServicio.PROGRAMADO,
            mascotas[2], new Servicio(TipoServicio.BAÑO, "Baño y corte", 60, 1000)),
        new Turno("2023-10-04", "13:00", EstadoServicio.PROGRAMADO,
            mascotas[3], new Servicio(TipoServicio.DESPARASITACION, "Corte de uñas", 15, 200)),
        new Turno("2023-10-05", "14:00", EstadoServicio.PROGRAMADO,
            mascotas[4], new Servicio(TipoServicio.BAÑO, "Baño y secado", 30, 600)),
        new Turno("2023-10-06", "15:00", EstadoServicio.PROGRAMADO,
            mascotas[0], new Servicio(TipoServicio.BAÑO, "Corte de pelo", 45, 800)),
        new Turno("2023-10-07", "16:00", EstadoServicio.PROGRAMADO,
            mascotas[1], new Servicio(TipoServicio.PELUQUERIA, "Baño completo", 30, 500)),
        new Turno("2023-10-08", "17:00", EstadoServicio.PROGRAMADO,
            mascotas[2], new Servicio(TipoServicio.DESPARASITACION, "Corte de uñas", 15, 200)),
        new Turno("2023-10-09", "18:00", EstadoServicio.PROGRAMADO,
            mascotas[3], new Servicio(TipoServicio.BAÑO, "Baño y corte", 60, 1000)),
        new Turno("2023-10-10", "19:00", EstadoServicio.PROGRAMADO,
            mascotas[4], new Servicio(TipoServicio.PELUQUERIA, "Baño y secado", 30, 600))
    };
  }

  public static Servicio[] obtenerServicios() {
    return new Servicio[]{
        new Servicio(TipoServicio.BAÑO, "Baño completo", 90, 500),
        new Servicio(TipoServicio.PELUQUERIA, "Corte de pelo", 45, 800),
        new Servicio(TipoServicio.DESPARASITACION, "Corte de uñas", 15, 200),
        new Servicio(TipoServicio.BAÑO, "Baño y corte", 60, 1000),
        new Servicio(TipoServicio.PELUQUERIA, "Baño y secado", 30, 600)
    };
  }
}
